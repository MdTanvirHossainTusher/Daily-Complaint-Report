...
raw_dump_file_name_for_pywin = r'I:\Openpyxl_tutorial\test\Raw Dump.xlsx'
...
def filter_item():
    ...
    workbook = excel.Workbooks.Open(raw_dump_file_name_for_pywin)
    ...
    workbook.SaveAs(raw_dump_file_name_for_pywin)  # Optional: Save the changes
    workbook.Close()
