...
def filter_item():
    ...
    open_workbook = openpyxl.load_workbook(r'I:\Openpyxl_tutorial\test\13 Dec regional final.xlsx')
    ...
    # Save the workbook
    open_workbook.save(r'I:\Openpyxl_tutorial\test\regional_updated_testing.xlsx')

    # pywin
    excel = win32com.client.Dispatch("Excel.Application")
    excel.Visible = True  # Optional: Set to True if you want to see Excel while the code is running

    workbook = excel.Workbooks.Open(r'I:\Openpyxl_tutorial\test\regional_updated_testing.xlsx')
    ...
    workbook.SaveAs(r"I:\Openpyxl_tutorial\test\Regional_Pivot4.xlsx")  # Optional: Save the changes
    workbook.Close()
