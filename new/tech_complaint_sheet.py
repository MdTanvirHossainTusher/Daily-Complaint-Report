...
# Load 'regional.xlsx'
technology_wb = openpyxl.load_workbook('I:\Openpyxl_tutorial\Parts\Dec 4 Daily Technology Complaint Report(8 days).xlsx')
print("done--")
raw_dump_wb = openpyxl.load_workbook('I:\Openpyxl_tutorial\Parts\working_raw_dump_final.xlsx')
print("done+++++++++")

technology_sheet = technology_wb['Tech complaint']
raw_pivot_sheet = raw_dump_wb['Check RAW Piv']
assign_pivot_sheet = raw_dump_wb['Check Assign Piv']
...
technology_wb.save('NEW Technology 3.xlsx')
